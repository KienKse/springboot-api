...
public class CartaController {
    ...
    // Get - Carta
    @GetMapping("/carta/{id}")
    public @ResponseBody Carta getCartaById(@PathVariable Long id) {
        return cartaRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("CARTA", "id", id));
    }

    // Update Carta
    @PutMapping("/carta/{id}")
    public @ResponseBody Carta updateNote(@PathVariable(value = "id") Long cartaId,
    ...
    // Delete Carta
    @DeleteMapping("/carta/del/{id}")
    public @ResponseBody ResponseEntity<?> deleteNote(@PathVariable(value = "id") Long cartaId) {
        Carta carta = cartaRepository.findById(cartaId)
